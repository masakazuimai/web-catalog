    ...
    if (turnPageNo === 2) {
      page.append(
        $("<div>", {
          ...
          <h2>本カタログについて</h2>
           <p>
              本カタログは、RINIAが制作したカタログ・メニュー表のデザインサンプルです。
            </p>
            <p>
              実際の業務・商業用途を想定し、見やすさと使いやすさを重視して設計しています。
              店舗用メニュー、商品カタログ、サービス案内など、幅広いシーンでの活用を想定しています。
            </p>
            <p>
              掲載内容はあくまで一例であり、デザイン・構成・仕様は目的やターゲットに応じて
              柔軟にカスタマイズ可能です。ブランドイメージや導線設計を踏まえたご提案も承っております。
            </p>
        `,
        })
      );
